...
&= \frac{1}{N} \int  \frac{ \left (2\pi \right )^{-t} \left ( \prod\_{k}  \exp \left ( - \frac{1}{2} s\_{k}^{2} \right ) \right ) \left ( \prod\_{k}  \exp \left ( - \frac{1}{2} s\_{k}^{2} \right ) \right )  }{ \prod\_{k}  \left ( 2\pi \sigma^{2} \right )^{-1} } d s\_{1:t} - 1
