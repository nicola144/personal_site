...
&= \frac{1}{N} \int   \frac{(2\pi)^{-t} \left (\prod\_{k}  \exp \left ( -\frac{1}{2}s\_{k}^{2} \right ) \right ) \left (\prod\_{k}  \exp \left ( -\frac{1}{2} s\_{k}^{2} \right ) \right )}{\prod\_{k} (2\pi \sigma^2)^{-1/2} \exp \left ( -\frac{1}{2\sigma^{2}} s\_{k}^{2} \right ) } d s\_{1:t} - 1 
